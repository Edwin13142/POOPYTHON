...
def open_registro():
    win1.withdraw() #Esconde la principal
    w2 = Toplevel(win1) #Creacion de segunda
    w2.title("REGISTRO")
    w2.geometry("720x640")
    frame2=Frame(w2)
    ...
    def killwin2():  
        w2.destroy()  #Esconde pantlla 2 
        win1.deiconify() #Hace que se vuelva a mostrar la pantalla 1
